        ...
        <div>
            ...
            <motion.div 
                ...
                <div className="projectFlex">                            
                    <video src={alarm}  autoPlay loop muted playsInline controls/>
                    <div className="space">
            ...
            <motion.div 
                ...
                <div className="projectFlex">
                    <video src={elden}  autoPlay loop muted playsInline controls/>
                    <div className="space">
            ...
            <motion.div 
                ...
                <div className="projectFlex">
                    <video src={dnd}  autoPlay loop muted playsInline controls/>
                    <div className="space">
            ...
            <motion.div 
                ...
                <div className="projectFlex">
                    <video src={portfolio}  autoPlay loop muted playsInline controls/>
                    <div className="space">
            ...
            <motion.div 
                ...
                <div className="projectFlex">
                    <video src={bugTracker}  autoPlay loop muted playsInline controls/>
                    <div className="space">

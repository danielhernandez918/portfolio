    ...
    return (
        <div >
            <div class="headerImage">
                ...
                {/* <h2 class="hide">Software Developer</h2> */}
            </div>
            <div id="row-about">
                {/* <button onMouseOver={changeBackground} onMouseLeave={changeBackground2}>Hover over me!</button> */}
            ...
            <div class="projectImage">
                ...
                {/* <h3 class="project-name">Snake Game</h3>
                <div class="projectFlex">
                    <video src={snake} width="1000" height="720" autoPlay loop muted/>
                    <p class="projectDesc">It's a game of snake. </p>
                </div> */}

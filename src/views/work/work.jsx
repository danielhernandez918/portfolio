        ...
        <div>
            ...
            <motion.div
                ...
                <div className="work">
                    ...
                    <h2 className="locationUnderline">Software Developer - Contract</h2>
                ...
                <div className="work">
                    ...
                    <h2 className="locationUnderline">Accountant</h2>
                    <ul className="responsiblities">
                ...
                <div className="work">
                    ...
                    <h2 className="locationUnderline">Underwriter / Credit Analyst</h2>
                    <ul className="responsiblities">
